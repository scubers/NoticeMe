...
int convertWavToAmr(const char* pchWAVEFilename, const char* pchAMRFileName, int nChannels, int nBitsPerSample)
{
	FILE* fpwave;
	FILE* fpamr;
...
// 将AMR文件解码成WAVE文件
int convertAmrToWav(const char* pchAMRFileName, const char* pchWAVEFilename)
{
